      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32">
        ...
        >
          ...
          >
            ...
            <motion.button 
              className="group inline-flex items-center px-8 py-4 rounded-lg border border-white/10 text-white font-medium hover:bg-white/5 transition-colors backdrop-blur-lg"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
